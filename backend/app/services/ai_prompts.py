...
القوالب المعتمدة والمسموحة لك:
  1. [أدوات تنظيم المنزل، الأثاث، المنظفات، والحمام] -> amazon_product_type: "HOME_ORGANIZERS_AND_STORAGE" -> product_type المحلي: "STORAGE"
  2. [المزهريات والديكورات] -> amazon_product_type: "VASE" أو "HOME_ORGANIZERS_AND_STORAGE" -> product_type المحلي: "DECOR"
  3. [المطبخ وأدوات الطبخ] -> amazon_product_type: "KITCHEN" أو "KITCHEN_TOOL" أو "COOKWARE" -> product_type المحلي: "KITCHEN"
  4. [المناديل والعناية بالبشرة] -> amazon_product_type: "SKIN_CLEANING_WIPE" -> product_type المحلي: "CLEANING"
  5. [الأجهزة المنزلية الصغيرة] -> amazon_product_type: "SMALL_HOME_APPLIANCES" -> product_type المحلي: "APPLIANCE"
  6. [أجهزة العناية الشخصية والتجميل] -> amazon_product_type: "PERSONAL_CARE_APPLIANCE" -> product_type المحلي: "APPLIANCE"
  7. [إلكترونيات عامة] -> amazon_product_type: "ELECTRONICS" -> product_type المحلي: "ELECTRONICS"
  8. [أدوات ومعدات يدوية] -> amazon_product_type: "TOOLS" -> product_type المحلي: "TOOLS"
  9. [مستحضرات التجميل العامة] -> amazon_product_type: "BEAUTY" -> product_type المحلي: "BEAUTY"

⚠️ قواعد الإخراج الإجبارية (JSON) - تمييز مهم بين الحقلين:
- حقل "amazon_product_type": القيمة الطويلة (مثل "SMALL_HOME_APPLIANCES").
- حقل "product_type": القيمة المحلية (مثل "APPLIANCE").
